...
public class DataImportProvider: IDataImportProvider
{
    ...
    {
        return await this._httpClient.GetDeserializedAsync<LeagueRootDTO>("https://fantasy.premierleague.com/api/leagues-classic/1650213/standings/?page_new_entries=1&page_standings=1&phase=1");
    }
    ...
    {
        return await this._httpClient.GetDeserializedAsync<HeadToHeadEventRootDTO>($"https://fantasy.premierleague.com/api/leagues-h2h-matches/league/1649633/?page=1&event={eventID}");
    }
