...
foreach (var gameWeekState in importedData)
{
    ...
    await using var connection = new SqlConnection("Persist Security Info=False;UID=SA;Pwd=!5omeSup3rF4ncyPwd!;Database=fantasy;Server=localhost,1431; Connection Timeout=30;TrustServerCertificate=True");
    ...
    foreach (var playerEvent in gameWeekState.User.Lineup)
    {
        ...
        await using var cnn = new SqlConnection("Persist Security Info=False;UID=SA;Pwd=!5omeSup3rF4ncyPwd!;Database=fantasy;Server=localhost,1431; Connection Timeout=30;TrustServerCertificate=True");
