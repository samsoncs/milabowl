...
public class TrendyBitch : MilaRule
{
    ...
    protected override string Description =>
        "Receive -1 penalty point if you transfer out the most popular transferred out player, and -1 point if you sub in the most popular transferred in player.";
    ...
    protected override RulePoints CalculatePoints(ManagerGameWeekState managerGameWeekState)
    {
        ...
        var trendyBitchInPoints = GetTrendyBitchPoints(
            ...
            managerGameWeekState
                .TransfersIn.Concat(managerGameWeekState.Opponents.SelectMany(o => o.TransfersIn))
                .ToList(),
            true
        );
        ...
        var trendyBitchOutPoints = GetTrendyBitchPoints(
            ...
            managerGameWeekState
                .TransfersOut.Concat(managerGameWeekState.Opponents.SelectMany(o => o.TransfersOut))
                .ToList(),
            false
        );
        ...
        return new RulePoints(
            points,
            $"{trendyBitchInPoints.Reasoning} {trendyBitchOutPoints.Reasoning}"
        );
    }

    private RulePoints GetTrendyBitchPoints(
        IList<Transfer> userSubs,
        IList<Transfer> allSubs,
        bool tradeIn
    )
    {
        var tradeCounts = allSubs
        ...
        )
        {
            ...
            var player = allSubs.First(a => a.FantasyPlayerEventId == mostTradedInPlayer.Player);
            return new RulePoints(
                -1,
                $"Traded {tradedInString} most popular player: {player.FirstName} {player.Surname}."
            );
        }
