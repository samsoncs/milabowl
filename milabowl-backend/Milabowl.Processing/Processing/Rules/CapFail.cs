...
public class CapFailScore : MilaRule
{
    ...
    protected override string Description =>
        "Receive -1 penalty points if captain scores less than 5 points.";
    ...
    protected override RulePoints CalculatePoints(ManagerGameWeekState userGameWeek)
    {
        ...
        var points = captain.TotalPoints < 5 ? -1 : 0;
        return new RulePoints(
            points,
            $"Captain {captain.FirstName} {captain.Surname} scored {captain.TotalPoints} pts."
        );
    }
}
