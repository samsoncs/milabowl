...
public class AllMilaRulesShouldHaveTest
{
    ...
    public void All_MilaRules_Should_Have_Test()
    {
        ...
        milaRuleTests.ShouldBeEquivalentTo(milaRules, $"all MilaRules should have a corresponding test class implementing MilaRuleTest<T> where T is the MilaRule type. Missing: {string.Join(",", milaRules.Where(r => !milaRuleTests.Contains(r)))}");
    }
