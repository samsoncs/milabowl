        ...
        {delta < 0 && 
            <div className="flex flex-row items-center justify-items-center text-red-700 dark:text-red-400">
                <div className="flex flex-col items-center">
                    ...
                    <svg style={{marginTop: -4}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="4" stroke="currentColor" className="w-2.5 h-2.5 md:w-4 md:h-4">
            ...
            <div className="flex items-center justify-items-center text-green-700 dark:text-green-400">
                <div className="flex flex-col items-center">
                    <div style={{marginBottom: -4}} >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="4" stroke="currentColor" className="w-2.5 h-2.5 md:w-4 md:h-4">
